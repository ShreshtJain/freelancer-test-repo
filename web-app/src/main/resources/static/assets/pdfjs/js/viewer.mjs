...
//   },
  ...
  workerSrc: {
    value: "/assets/pdfjs/js/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.defaultUrl = {
    value: "/assets/pdfjs/fallback.pdf",
    kind: OptionKind.VIEWER
  };
  defaultOptions.sandboxBundleSrc = {
    value: "/assets/pdfjs/js/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
